...
def run_autogenerate(form_details: dict=default_form_details) -> dict:
    ...
    gym_sessions = ["Cardio", "Legs", "Pull", "Push"]  # Backwards so that they can be pop() off.
...
def calculate_dates(week_monday: str) -> list:
    """Converts the date from "2022-10-25" to "20221025" and makes sure that the day is in the correct month.
