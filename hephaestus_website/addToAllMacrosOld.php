        ...
        <div>
            <div id="navDiv">
                ...
                <div id="navTextDiv">
                    ...
                    <a style="margin: 0 auto;" id="hobLink" href="addToDailyMacros.php">Insert Macros</a>
                    <a style="margin: 0 auto; color: orange;" id="macLink" href="addToAllmacros.php">Add Macros</a>
                </div>
            </div>
