...
<html>
    ...
    <body>
        <div class="darkBack" id="navBar">
            <a href="#toDoListDiv">To Do</a>
            <a href="#fitnessDiv">Measurements</a>
        </div>
        ...
        <div>
            ...
            <div id="toDoListDiv" class="darkBack">
                <br><br><br>
                <h1>To Do List</h1>
                <br><br>
                <h2>Current List</h2>
            ...
            <img class="transition" src="Images/Black to White.jpg"/>
            ...
            <div class="whiteBack">
                <br><br><br><br>
                <div id="fitnessDiv" class="whiteBack">
                    <br><br>
        ...
        <img class="transition" src="Images/White to Black.jpg" />
